...
from task4.tuning.tuning_gnn.smart_agent_for_nn import *
from task4.tuning.tuning_gnn.gnn_evaluator import GNNEvaluator
from task4.tuning.tuning_gnn.gnn_model import GNNetWrapper as gnn
