...
# commando om dit file uit te voeren : ./websocket_player.py task4/submit_files/tournament/dotsandboxes_agent.py 8080  
...
import pyspiel
import open_spiel
from new_kul_tournament import load_agent_from_dir
